...
RUN yarnpkg global add prettier eslint vscode-css-languageserver-bin typescript typescript-language-server dockerfile-language-server-nodejs intelephense bash-language-server
